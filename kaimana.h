...
class Kaimana
{
  ...
  public:
    Kaimana(void);
    void    setLED(int index, int iR, int iG, int iB, float BRIGHTNESS);
...
//
#define  COMBO_PATTERN_1A          ATTACK_LEFT
#define  COMBO_PATTERN_1B          ATTACK_RIGHT
#define  COMBO_PATTERN_2A          ATTACK_UP
#define  COMBO_PATTERN_2B          ATTACK_DOWN
#define  COMBO_PATTERN_3A          ATTACK_DOWN+ATTACK_UP
#define  COMBO_PATTERN_3B          ATTACK_RIGHT+ATTACK_LEFT
#define  COMBO_PATTERN_4A          ATTACK_DOWN+ATTACK_RIGHT
#define  COMBO_PATTERN_5A          ATTACK_P3+ATTACK_K3
#define  COMBO_PATTERN_6A          ATTACK_UP+ATTACK_LEFT
#define  COMBO_PATTERN_CL          ATTACK_DOWN+ATTACK_UP
